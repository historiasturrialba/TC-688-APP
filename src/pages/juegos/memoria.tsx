  ...
  return (
    <div className="min-h-screen p-6 relative" style={{ backgroundColor: '#F9F4E1' }}>
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        {/* Score */}
        <div className="text-center mb-8">
          <div className="inline-block px-8 py-4 rounded-xl shadow-lg" 
               style={{ backgroundColor: '#001E33' }}>
            <span className="text-lg font-medium" style={{ color: '#F9F4E1' }}>
              Puntos: 
            </span>
            <span className="text-2xl font-bold ml-2" style={{ color: '#56915D' }}>
              {score}
            </span>
          </div>
        </div>
        ...
        {won && (
          <div className="text-center mb-8">
            <div className="inline-block px-8 py-6 rounded-xl shadow-lg" 
                 style={{ backgroundColor: '#56915D' }}>
              <h2 className="text-3xl font-bold mb-4" style={{ color: '#F9F4E1' }}>
                🎉 ¡Excelente trabajo! 🎉
              </h2>
            ...
            <div key={i} className="group">
              <div
                ...
                className={`
                  ...
                  ${disabled && !isFlipped(card) ? 'cursor-not-allowed opacity-50' : ''}
                    ...
                    <div className="mb-2">
                      <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 2L13.09 8.26L19 7L14.74 12L19 17L13.09 15.74L12 22L10.91 15.74L5 17L9.26 12L5 7L10.91 8.26L12 2Z" 
                              fill="#F9F4E1" opacity="0.8"/>
                      </svg>
                    </div>
                    <span className="text-lg font-bold" style={{ color: '#F9F4E1' }}>
                      ?
                    </span>
                    <div className="mt-2 w-8 h-0.5" style={{ backgroundColor: '#866D4E' }}></div>
                  </div>
                )}
              </div>
            </div>
